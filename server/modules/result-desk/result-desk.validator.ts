...
const statusEnum = Joi.string().valid("pending", "ocr_done", "ocr_human_done", "rejected");
...
export const listDeskSchema = Joi.object({ query: Joi.object({ desk: objectId.optional(), party: objectId.optional(), status: statusEnum.optional(), owner: objectId.optional(), ...paginationQuery }).required() }).unknown(true);
