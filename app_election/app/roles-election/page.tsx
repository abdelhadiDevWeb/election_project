...
export default function RolesElection() {
  const [observersData, setObserversData] = useState([
    { id: 1, name: "Karim Slimani", role: "Observateur Bureau", center: "Centre Pasteur", desk: "08", location: "Centre Pasteur - Bureau 08", code: "TMP-882-X", status: "Actif", expires: "20:00", email: "k.slimani@gmail.com" },
    { id: 2, name: "Sara Haddad", role: "Chef de Centre", center: "Centre Ibn Badis", desk: "", location: "Centre Ibn Badis", code: "TMP-441-Y", status: "Actif", expires: "22:00", email: "s.haddad@gmail.com" },
    { id: 3, name: "Ahmed Mansour", role: "Observateur", center: "Centre Emir Abdelkader", desk: "", location: "Centre Emir Abdelkader", code: "TMP-901-Z", status: "Expiré", expires: "08:00 (Fermé)", email: "a.mansour@gmail.com" },
  ]);
